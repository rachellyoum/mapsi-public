...
struct TripResultView: View {
    ...
    var body: some View {
        ...
        .onDisappear {
            if selectedDetailItem == nil && !showAddStop {
                restoreCustomTabBar()
            }
        }
    ...
    private func goHome() {
        ...
        NotificationCenter.default.post(
            name: Notification.Name("ClosePlanning"),
            object: nil
        )
    ...
    private func restoreCustomTabBar() {
        NotificationCenter.default.post(
                        ...
                        if isEditMode {
                            ...
                            Button {
                                selectedDetailItem = PlaceDetailItem(
                                    ...
                                    stop_price_level: item.stop_price_level,
                                    notes: item.notes,
