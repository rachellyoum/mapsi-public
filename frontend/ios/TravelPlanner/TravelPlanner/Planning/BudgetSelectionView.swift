...
struct BudgetSelectionView: View {
    ...
    private func saveCurrentTrip() {
        ...
        let scheduleItem = MyScheduleItem( //fix
...
private struct AirplaneLoadingOverlay: View { //fix
        ...
        ZStack {
                ...
                Image(systemName: "airplane")
                    ...
                    .background(
                        Circle()
                            ...
                            .shadow(color: midGreen.opacity(0.2), radius: 10, x: 0, y: 4)
                    )
                    .offset(y: -90)
            ...
            VStack(spacing: 220) {
                Text("Creating your trip...")
                    .font(.system(size: 16, weight: .semibold))
                    .foregroundStyle(midGreen.opacity(0.85))
                    .tracking(0.4)
            }
        }
